...
<template>
  <div class="student d-flex justify-content-center align-items-center w-100">
        ...
        <table
          ...
          <tbody>
            <tr
              ...
              <td
                class="p-2 d-flex border-bottom d-flex justify-content-center align-items-center">
                <!-- Create Button -->
                <button
