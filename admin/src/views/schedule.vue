  ...
  <div class="app-wrapper">
    <div
      ...
      <section class="main-container">
        <div
          class="box card2 border-top border-start border-end border-bottom p-2 w-100 rounded-3">
          <div class="container1 w-100 h-100 w-100 rounded p-2 border-dark">
            <div
              ...
              <div class="btn-container border-1 d-flex gap-3">
                ...
                <button
                  class="w-20 px-3 px-3 h-100 border border-gray-300 rounded-1 btn-custom">
                  Import
                </button>
                <button
                  class="w-20 px-3 py-1 border-gray-200 h-100 border rounded-1 btn-custom">
                  Export
                </button>
              </div>
            </div>
            <form
              class="d-flex w-20 flex-end justify-content-end w-100 mt-3 mb-3">
              <input
            ...
            <div class="card-body w-100" id="schedules">
          ...
          <div class="container2 w-100 h-100 rounded p-3">
            <div
              class="border-bottom w-100 p-2 justify-content-between d-flex m-2">
              Year Level
              <div class="btn-container border-1 d-flex gap-3">
                <button class="w-20 p-1 h-100 border-1 rounded-1">+ New</button>
                <button class="w-20 p-1 h-100 border-1 rounded-1">
                  Delete
                </button>
                <button class="w-20 p-1 h-100 border-1 rounded-1">
                  Import
          ...
          <div class="container3 w-100 h-100 rounded p-3">
            <div
              class="border-bottom w-100 p-2 justify-content-between d-flex m-2">
              Year Level
              <div class="btn-container border-1 d-flex gap-3">
            ...
            <form class="d-flex w-20 flex-end justify-content-end">
              <input
                class="form-control me-2 w-25"
                type="search"
                placeholder="Search"
          ...
          <div class="container4 w-100 h-100 rounded p-3">
            <div
              class="border-bottom w-100 p-2 justify-content-between d-flex m-2">
              Year Level
              <div class="btn-container border-1 d-flex gap-3">
    ...
    async fetchSchedules() {
      ...
      try {
        const response = await axios.get(
          "http://localhost:8080/capstone/admin/backend/api/fetchschedule.php"
        );
